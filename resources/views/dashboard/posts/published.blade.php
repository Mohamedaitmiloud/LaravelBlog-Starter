          ...
          <div class="card">
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                        <a href="{{route('posts.create')}}" class="btn btn-success btn-block float-right">Add new </a>
                </div>
                </div>
                  ...
                  <table id="posts" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <td><a href="{{route('posts.edit',['id'=>$post->id])}}" class="btn btn-secondary btn-block">Edit</a></td>
