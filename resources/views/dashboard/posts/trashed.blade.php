                  ...
                  <table id="posts" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <td><a href="{{route('posts.restore',['id'=>$post->id])}}" class="btn btn-success btn-block">Restore</a></td>
                                <td><a href="{{route('posts.delete',['id'=>$post->id])}}" class="btn btn-danger btn-block">Delete</a></td>
